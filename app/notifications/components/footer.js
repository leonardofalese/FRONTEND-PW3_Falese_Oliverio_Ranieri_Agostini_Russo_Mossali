                    ...
                    <div className={styles.footerDiv}>
                        ...
                        <div className={styles.footerSection}>
                            ...
                            <ul className={styles.ul}>
                                ...
                                <li className={styles.li}><Link className={styles.link} href="/notifications">Notifiche</Link></li>
                                <li className={styles.li}><Link className={styles.link} href="/calendar">Calendario</Link></li>
                            </ul>
                        </div>
                    </div>
                    <div className={styles.footerDiv}>
